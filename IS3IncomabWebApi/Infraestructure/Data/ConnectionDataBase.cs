        ...
        public IDbConnection GetConnection {get
            {
                ...
                sqlConnection.ConnectionString = (sqlConnection.WorkstationId.Equals(_configuration.GetConnectionString("DesktopArthur"))) ? _configuration.GetConnectionString("ConnectionDB") : _configuration.GetConnectionString("ConnectionC");
                sqlConnection.Open();
